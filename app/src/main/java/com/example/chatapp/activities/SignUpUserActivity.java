...
import com.example.chatapp.databinding.ActivitySignUserUpBinding;
...
public class SignUpUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySignUserUpBinding.inflate(getLayoutInflater());
    ...
    private void signUp() {
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.putString(Constants.KEY_USERS_ID, documentReference.getId());
                    preferenceManager.putString(Constants.KEY_NAME, binding.inputName.getText().toString());
                    preferenceManager.putString(Constants.KEY_IMAGE, encodedImage);
                    preferenceManager.putString(Constants.KEY_TYPE_ACC2, "User");
