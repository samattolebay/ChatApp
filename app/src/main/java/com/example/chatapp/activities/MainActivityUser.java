...
import com.example.chatapp.databinding.ActivityMainUserBinding;
...
public class MainActivityUser extends BaseActivity implements ConversionListener {
        ...
        if (value != null) {
            for (DocumentChange documentChange : value.getDocumentChanges()) {
                if (documentChange.getType() == DocumentChange.Type.ADDED) {
                    ...
                    if (preferenceManager.getString(Constants.KEY_USERS_ID).equals(senderId)) {
    ...
    private void signOut() {
        ...
        documentReference.update(updates)
                ...
                .addOnFailureListener(e -> showToast("Не удалось зарегистрироваться"));
    }
